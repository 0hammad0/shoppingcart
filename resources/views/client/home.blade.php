...
@section('content')
    ...
    <section id="home-section" class="hero">
		  ...
		  <div class="slider-item" style="background-image: url(slider_images/{{$sliders -> slider_image}});">
			<div class="overlay"></div>
		  <div class="container">
			<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

			  <div class="col-md-12 ftco-animate text-center">
				<h1 class="mb-2">{{$sliders -> description1}}</h1>
				<h2 class="subheading mb-4">{{$sliders -> description2}}</h2>
    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="product_images/{{$products -> product_image}}" alt="{{$products -> product_name}}">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price">
										...
										<span class="price-sale">${{$products -> product_price}}</span>
									</p>
		    					</div>
	    					</div>
	    					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
	    							...
	    							<a href="{{URL::to ('/addtocart', $products -> id)}}" class="buy-now d-flex justify-content-center align-items-center mx-1">
