	    				...
	    				<table class="table">
						    ...
						    <tbody>
								@if (Session::has('cart'))
									...
									<tr class="text-center">
										<td class="product-remove"><a href="{{('/remove_from_cart/'.$product ['product_id'])}}"><span class="ion-ios-close"></span></a></td>
										
										<td class="image-prod"><div class="img" style="background-image:url(product_images/{{$product ['product_image']}});"></div></td>
